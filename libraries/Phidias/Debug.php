...
class Debug
{
    ...
    public static function flush()
    {
        ...
        $view = new View;
        $view->templates("phidias/debugger");
        $view->acceptTypes(HTTP\Request::getBestSupportedMimeType());

        $view->set('messages',      self::$messages);
        $view->set('peakMemory',    memory_get_peak_usage());
        $view->set('totalTime',     microtime(true) - self::$initialTimestamp);
